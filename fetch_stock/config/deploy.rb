...
role :web, "fetch_stock.com"                          # Your HTTP server, Apache/etc
role :app, "fetch_stock.com"                         # This may be the same as your `Web` server
role :db,  "fetch_stock.com"   , :primary => true # This is where Rails migrations will run
